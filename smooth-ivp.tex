\section{Smooth differentiable equations}
...
in this thesis is defined only when the domain is a bounded closed region.%
\footnote{%
Although we could extend our definition to 
functions with unbounded domain~%
\cite[Sect.~4.1]{kawamura2012complexity}, 
...
\subsection{Other Versions of the Problem}

\subsubsection{Complexity of the Final Value}
...
\subsubsection{Type-two complexity of differentiable equations of class $\classC^1$}
...
Following \cite{kawamura2012complexity},
...
In \cite[Theorem 4.9]{kawamura2012complexity}, the
...
because of \cite[Lemmas 3.7 and 3.8]{kawamura2012complexity}. 
