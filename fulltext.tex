...
Let $\delta$ and $\gamma$ be representations of sets of $X$ and $Y$, respectively.
We say that $A \pcolon X \rightrightarrows Y$ is $(\delta, \gamma)$-$\classFPtwo$-$\le$-hard 
if $\gamma^{-1} \circ A \circ \delta$ is $\classFPtwo$-$\le$-hard.
See Section~\ref{subsection: representations} for the definition of $\gamma^{-1} \circ A \circ \delta$.
...
degree $n$ monic polynomials as follows: 
