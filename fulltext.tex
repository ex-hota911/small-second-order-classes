...
\label{theorem:hoover1991-4.5}
 ...
 such that $f|_{[2k, 2k+1]}$ is contractive for each $k \in \N$ and
 a function mapping 
 a pair of a number $k \in \N$ (written in binary) and the string $0^n$
 to a $2^{-n}$-approximation of the (unique by the Banach fixpoint theorem) 
...
The operation $\OpCMFix^2$ is defined as follows:
$\dom \OpCMFix^2$ is a set of real functions 
