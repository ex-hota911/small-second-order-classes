...
This led them to defining type-two classes analogues of 
$\classP$, $\classNP$, and $\classPSPACE$ 
and studying important operators in analysis
that are computable and complete for these classes. 
Refining their model, 
we define type-two analogues of the log-space class $\classL$ and
the circuit class $\classNC$.
We also define the type-two $\classP$-completeness under suitable log-space reductions.
The basic idea is to use
second-order polynomials as resource bounds, 
as Kawamura and Cook did, 
but there are several new subtleties that must be taken care of 
