...
%%!!! "runs in second-order polynomial time"未定義
\end{definition}
...
We say $\phi$ is a {\em $\gamma$-name} of $x$
if $x = \gamma (\phi)$.
...
(such as the usual complexity classes $\classFP$ and $\classFL$), 
...
defined by Ko equals
$(\rhoR|^{[0,1]},\rhoR)$-$\classFPtwo$.
...
\begin{lemma}
 ...
 and there is a polynomial-time computable function 
 $\phi \colon (\D \cap [0, 1]) \times \{0, 1\} ^* \to \D$ such that 
 \begin{equation}
