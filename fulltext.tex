...
or as oracles that answer queries, 
and they are equivalent as long as we only discuss computability, 
but 
Kawamura and Cook \cite{kawamura2012complexity} recently pointed out 
that when we want to pay attention to 
bounds on time and space, 
it is more appropriate to use oracle machines 
with random access and 


\emph{length-monotone} string functions. 
