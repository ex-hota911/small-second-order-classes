...
We will use this lemma to derive
non-uniform results (the existence of $\classFP$-hard solution) from 
uniform results ($\classFPtwo$-$\redLmF$-hardness of an operation). 
...
We say that $A \pcolon X \rightrightarrows Y$ is $(\gamma, \delta)$-$\classFPtwo$-$\le$-hard 
...
\begin{lemma}
 ...
 Let $\gamma$ and $\delta$ be representations of sets $X$ and $Y$.
