...
operator $F \colon \classC [0, 1] \to \classC [0, 1]$ on real functions. 
This extended the previously accepted notion of 
...
\end{quote}
where $\mathcal{X, Y, Z}$ are type-two complexity classes analogous to ${X, Y, Z}$ (see \cite{kawamura2012complexity} for more details).

We continue their research and proceed down into $\classP$. 
We study analogues of the logarithmic-space 
