...
will help us in Sect.~\ref{section:P-complete} to show that the known 
non-uniform results (the existence of an $\classFP$-hard output) follow from 
...
the reduction $\redLB$; cf.~\cite[Lemma~3.6]{kawamura2012complexity}.
...
\begin{example}
The circle ratio $\pi$ is in $\rhoR$-$\classFL$ by the series
\begin{equation}
