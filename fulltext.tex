...
% Neff's algorithm for finding the roots of a given polynomial 
% in type-two $\classNC$; 
...
In this section, we investigate the complexity of several problems in numerical
analysis using our new classes introduced in the previous section.
...
\subsection{Operations in $\classFLtwo$ and $\classFNCtwo$}
...
\subsubsection{Real functions in $\classL$}
...
\subsubsection{Finding polynomial roots in $\classFNCtwo$}

We show that
finding roots of a complex polynomial from its coefficients is 
