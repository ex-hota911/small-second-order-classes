...
Let $\mathcal C$ be a class of multi-functions from $\LM$ from $\LM$,
...
Hoover's theorem about the complexity of computing fix points
...
\label{theorem:hoover1991-4.5}
 ...
 such that $f|_{[2n, 2n+1]}$ is contractive for all $n \in \N$ and
